...
function renderCommercialLanding() {
  ...
  main.innerHTML = `
      ...
      <div class="bt8-hero-inner">
        <div class="bt8-hero-copy">
          ...
          <div class="bt8-proof-row">
            <span>1 torneio gratis sem cadastro</span>
            <span>Conta Free disponivel</span>
          ...
          <div class="bt8-phone">
            ...
            <div class="bt8-round-card active">
              ...
              <div class="bt8-game-row done">
                ...
                <div><b>Joao<br>Marcos</b></div>
                <em>VS</em>
                <div>Jorge<br>Ray</div>
                <strong>6 x 5</strong>
              </div>
              <div class="bt8-winner">Joao + Marcos</div>
              <div class="bt8-game-row done">
            ...
            ${['Joao','Marcos','Spoto','Talysson','Jorge','Ray'].map((name, i) => `
              <div class="bt8-rank-line">
                <b>${i < 3 ? ['1o','2o','3o'][i] : (i + 1) + 'o'}</b>
                <span>${name}</span>
    ...
    <section class="bt8-proof-strip lp-s">
      ...
      <div><strong>Duplas fixas e aleatorias</strong><span>com regras guiadas</span></div>
      <div><strong>Ranking compartilhavel</strong><span>sem refazer conta</span></div>
    </section>

    <section class="bt8-section bt8-problem lp-s">
      <div class="bt8-section-copy">
        <span class="bt8-kicker">O problema real</span>
        <h2>O torneio nao quebra por falta de jogo. Quebra na organizacao.</h2>
        <p>Quando tudo fica em papel, planilha ou conversa de WhatsApp, alguem sempre precisa parar para conferir rodada, dupla, descanso, placar e ranking.</p>
      </div>
      <div class="bt8-pain-grid">
        <div><b>Quem joga agora?</b><span>A rodada vira pergunta repetida.</span></div>
        <div><b>Quem descansou?</b><span>O equilibrio some no improviso.</span></div>
    ...
    <section class="bt8-section lp-s">
      ...
      <h2>Um fluxo simples para quem precisa resolver rapido.</h2>
      <div class="bt8-steps">
        <div><strong>1</strong><b>Escolha a modalidade</b><span>Super 4, 6, 8, 12, mistas, duplas fixas ou aleatorias.</span></div>
        <div><strong>2</strong><b>Cadastre jogadores</b><span>O app mostra o que falta e evita combinacoes invalidas.</span></div>
    ...
    <section class="bt8-section bt8-formats lp-s">
      <span class="bt8-kicker">Nao e uma tabela generica</span>
      <h2>O BT8 ja entende os formatos que a galera joga.</h2>
      <div class="bt8-format-grid">
        ${[
          ['Super 4', '4 jogadores, 3 rodadas, rapido para grupo pequeno.'],
          ['Super 8', '7 rodadas, todos os pares, ideal para duas quadras.'],
          ['Super 12', 'grupo maior, mais jogos, mesma logica guiada.'],
          ['Super Mista', 'homens e mulheres em combinacoes rotativas.'],
    ...
    <section class="bt8-human lp-s">
      ...
      <div class="bt8-human-card">
        ...
        <h2>Uma experiencia mais profissional, mesmo no torneio entre amigos.</h2>
        <p>Quando a rodada aparece clara e o ranking atualiza na hora, o grupo confia mais no torneio. E voce organiza sem precisar ser a planilha ambulante do dia.</p>
      </div>
    </section>

    <section class="bt8-section bt8-benefits lp-s">
      <span class="bt8-kicker">Beneficios do Pro</span>
      <h2>Quando organizar vira rotina, o Pro paga pelo tempo que devolve.</h2>
      <div class="bt8-benefit-grid">
        <div><b>Torneios ilimitados</b><span>Para quem organiza toda semana ou toca eventos com frequencia.</span></div>
        <div><b>Historico completo</b><span>Consulte torneios antigos e preserve resultados importantes.</span></div>
        <div><b>Ranking pronto para compartilhar</b><span>Menos print confuso, mais resultado bonito no grupo.</span></div>
        <div><b>Cancelamento justo</b><span>No mensal, cancelar para a proxima cobranca mantem o acesso ate o fim do ciclo.</span></div>
      </div>
    </section>

    <section class="bt8-section bt8-plans lp-s" id="bt8-plans">
      <span class="bt8-kicker">Escolha como comecar</span>
      <h2>Teste gratis, use Free ou libere o Pro.</h2>
      <div class="bt8-plan-grid">
        <div class="bt8-plan">
          <span>Teste avulso</span>
          <h3>R$ 0</h3>
          <p>Para experimentar agora, sem criar conta.</p>
          <ul><li>1 torneio gratis por mes</li><li>Sem historico salvo</li><li>Ideal para sentir o app</li></ul>
        ...
        <div class="bt8-plan">
          ...
          <ul><li>Conta gratuita</li><li>Historico limitado</li><li>Bom para torneios pontuais</li></ul>
          <button onclick="bt8PrimaryCta('bt8_landing_free')">Criar conta gratis</button>
        </div>
        <div class="bt8-plan featured">
          <small>Mais indicado</small>
          <span>Pro Mensal</span>
          <h3>R$ 6,90<em>/mes</em></h3>
          <p>Para professores, grupos e organizadores recorrentes.</p>
          <ul><li>Torneios ilimitados</li><li>Historico completo</li><li>Cancele quando quiser</li></ul>
        ...
        <div class="bt8-plan">
          ...
          <ul><li>Pagamento unico</li><li>30 dias de Pro</li><li>Sem renovacao automatica</li></ul>
    ...
    <section class="bt8-section bt8-faq lp-s">
      <span class="bt8-kicker">Duvidas comuns</span>
      <h2>Antes de criar seu primeiro torneio.</h2>
      <details open><summary>Preciso criar conta para testar?</summary><p>Nao. Voce pode gerar 1 torneio gratis por mes sem cadastro. Para salvar historico, crie conta.</p></details>
      <details><summary>O plano Free e gratis mesmo?</summary><p>Sim. Ele serve para uso ocasional, com limite mensal de torneios salvos.</p></details>
      <details><summary>O Pro 30 Dias renova sozinho?</summary><p>Nao. E pagamento unico. Se quiser, voce pode assinar o mensal e deixar a cobranca comecar no vencimento dos 30 dias.</p></details>
      <details><summary>Se eu cancelar o mensal, perco acesso na hora?</summary><p>Nao. O Pro segue ativo ate a data em que a proxima cobranca aconteceria.</p></details>
    </section>

    <section class="bt8-final lp-s" id="lp-cta-final">
      <div>
        <span class="bt8-kicker">Comece agora</span>
        <h2>Seu proximo torneio nao precisa nascer numa planilha.</h2>
